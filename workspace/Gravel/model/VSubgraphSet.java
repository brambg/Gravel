...
public class VSubgraphSet extends Observable implements Observer {
   ...
   *
   * @param i index of the set
   * @return null, if no set with index i exists, else the set
   */
   ...
   *
   * @param subgraphindex Index of the set to be deleted
   */
   ...
   *
   * @param edgeindex     edge index of the edge to be removed
   * @param subgraphindex set index of the set
   */
   ...
   *
   * @param nodeindex the node to be added
   * @param SetIndex  the set to be expanded
   ...
   *
   * @param nodeindex the node index to be removed from the
   * @param SetIndex  set with this index
   */
   ...
   *
   * @return an Iterator typed to VSubgraphs
   */
