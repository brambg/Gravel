...
public class JEdgeDialog extends JDialog implements ActionListener, ItemListener {
  ...
  private void CreateDialog(VEdge e, VGraph vG) {
    ...
    c.gridy++;
    TextContent.add(cLine.getContent(), c);
  ...
  private void buildEdgeTypeParameterfields() {
    ...
    c.gridx = 0;
    c.anchor = GridBagConstraints.WEST;
    iQCx = new IntegerTextField();
    iQCx.setPreferredSize(tfdim);
    cQuadCurve.add(new JLabel("Bezier-Punkt X"), c);
    c.gridx++;
    cQuadCurve.add(iQCx, c);
    c.gridy++;
    c.gridx = 0;
    iQCy = new IntegerTextField();
    iQCy.setPreferredSize(tfdim);
    ...
    c.gridy = 0;
    c.gridx = 2;
    iSegx = new IntegerTextField();
    iSegx.setPreferredSize(tfdim);
    cSegmented.add(iSegx, c);
    c.gridy = 1;
    c.gridx = 1;
    cSegmented.add(new JLabel(" Y  "), c);
    c.gridx = 2;
    iSegy = new IntegerTextField();
    iSegy.setPreferredSize(tfdim);
