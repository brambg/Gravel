...
public class JPreferencesDialog extends JDialog implements ActionListener, ItemListener, ChangeListener, CaretListener, KeyListener {
  ...
  private JPanel buildGraphPane() {
    ...
    GraphMainType.add(rGraph);
    GraphMainType.add(rHyperGraph);
    content.add(rGraph, c);
    c.gridx++;
    content.add(rHyperGraph, c);
    ...
    GraphType.add(rDirected);
    GraphType.add(rUndirected);
    content.add(rDirected, c);
    c.gridx++;
    content.add(rUndirected, c);
    ...
    c.gridy++;
    content.add(tSubgraphPreview, c);
