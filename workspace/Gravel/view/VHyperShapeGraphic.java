...
import history.HyperEdgeShapeHistoryManager;
...
public class VHyperShapeGraphic extends VHyperGraphic {
  ...
  private void paintModificationDetails(Graphics2D g2) {
    ...
    if ((tempshape == null) || (tempshape.isEmpty()))
      return;
    if ((actualMouseState & SUBCURVE_MOUSEHANDLING) > 0) { //Draw CP always in that modus
    ...
    if ((actualMouseState & SUBCURVE_MOUSEHANDLING) > 0) { //This modus always delivers the shape including an subcurve, though this might be an empty shape
