...
public class GraphTree extends JTree implements TreeSelectionListener,
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getSource() == Properties) {
    ...
    } else if (e.getSource() == HyperEdgeShape) { //Only Happens in Hypergraohs, because this item is not exitent else
      ...
      {
        case USENODES: {
          msg += "den Knoten <br> " + Knotennamen.elementAt(selectedPosition + 1) + "<br>l" + main.CONST.html_oe + "schen ?";
          break;
        }
        case USEEDGES: {
          msg += "Die ";
        ...
        case USESUBGRAPHS: {
          msg += "den Untergraphen " + Mengennamen.elementAt(selectedPosition + 1) + "<br>l" + main.CONST.html_oe + "schen ?<br>(Knoten und Kanten bleiben bestehen)";
          break;
        }
        default: {
          return;
