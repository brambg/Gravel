  ...
  protected VGraphInterface doReplace(VGraphInterface graph) throws GraphActionException {
    ...
    switch (Objecttype) {
      ...
      case GraphConstraints.SUBGRAPH:
        ...
        break;
      default:
        throw new GraphActionException("GraphAction::doReplace(); Unknown ActionObject");
    }
    ...
    switch (Objecttype) {
      case GraphConstraints.NODE:
        ...
        while (ei.hasNext()) {
          ...
          if ((me.StartIndex == n.getIndex()) || (me.EndIndex == n.getIndex())) { //Add all Adjacent Edges again and recreate theis color
